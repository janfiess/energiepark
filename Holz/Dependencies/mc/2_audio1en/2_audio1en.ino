...
const char* mqtt_client_id = "headphone_station_audio1en";

const char* MQTT_PUBLISH_TOPIC_AUDIO = "holz/player/audio1en";                    // Topics.  -   Diese werden für Subscribing und Publishing genutzt
const char* MQTT_SUBSCRIBE_TOPIC_SECTIONS_LEDRING = "holz/ledring_audio1en/numsections";      // Payload: 0 - 12
const char* MQTT_SUBSCRIBE_TOPIC_TRACK_STATE = "holz/ledring_audio1en/state"; 
...
String target_id = "241A5FD6";
String target_id_B = "F40735D6";
