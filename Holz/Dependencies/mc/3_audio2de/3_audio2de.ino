...
const char* mqtt_client_id = "headphone_station_audio2de";

const char* MQTT_PUBLISH_TOPIC_AUDIO = "holz/player/audio2de";                    // Topics.  -   Diese werden für Subscribing und Publishing genutzt
const char* MQTT_SUBSCRIBE_TOPIC_SECTIONS_LEDRING = "holz/ledring_audio2de/numsections";      // Payload: 0 - 12
const char* MQTT_SUBSCRIBE_TOPIC_TRACK_STATE = "holz/ledring_audio2de/state"; 
...
String target_id = "94326BD6";
String target_id_B = "271652FA";
