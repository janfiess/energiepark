...
const char* mqtt_client_id = "headphone_station_audio2en";

const char* MQTT_PUBLISH_TOPIC_AUDIO = "holz/player/audio2en";                    // Topics.  -   Diese werden für Subscribing und Publishing genutzt
const char* MQTT_SUBSCRIBE_TOPIC_SECTIONS_LEDRING = "holz/ledring_audio2en/numsections";      // Payload: 0 - 12
const char* MQTT_SUBSCRIBE_TOPIC_TRACK_STATE = "holz/ledring_audio2en/state"; 
...
String target_id = "74A06BD6";
String target_id_B = "27E655FA";
