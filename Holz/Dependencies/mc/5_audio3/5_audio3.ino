...
const char* MQTT_PUBLISH_TOPIC_AUDIO = "holz/player/audio3";                    // Topics.  -   Diese werden für Subscribing und Publishing genutzt
const char* MQTT_SUBSCRIBE_TOPIC_SECTIONS_LEDRING = "holz/ledring_audio3/numsections";      // Payload: 0 - 12
const char* MQTT_SUBSCRIBE_TOPIC_TRACK_STATE = "holz/ledring_audio3/state"; 
...
String target_id = "747E6AD6";
String target_id_B = "477251FA";
