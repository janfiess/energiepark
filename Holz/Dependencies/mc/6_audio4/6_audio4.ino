...
const char* mqtt_client_id = "headphone_station_audio4";

const char* MQTT_PUBLISH_TOPIC_AUDIO = "holz/player/audio4";                    // Topics.  -   Diese werden für Subscribing und Publishing genutzt
const char* MQTT_SUBSCRIBE_TOPIC_SECTIONS_LEDRING = "holz/ledring_audio4/numsections";      // Payload: 0 - 12
const char* MQTT_SUBSCRIBE_TOPIC_TRACK_STATE = "holz/ledring_audio4/state"; 
...
String target_id = "C4B86DD6";
String target_id_B = "D7091DFA";
